...
view endpoint model =
    ...
    div
        []
        [ Title.view "Effects for Transaction" "https://www.stellar.org/developers/horizon/reference/endpoints/effects-for-transaction.html"
        , div
            [ Css.page ]
            [ RequestTitle.view "EffectsForTransaction"
            ...
            , Response.view "EffectsForTransaction" model.response model.isLoading
            ]
        ]