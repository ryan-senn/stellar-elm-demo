...
view endpoint model =
    ...
    div
        []
        [ Title.view "Effects for Operation" "https://www.stellar.org/developers/horizon/reference/endpoints/effects-for-operation.html"
        , div
            [ Css.page ]
            [ RequestTitle.view "EffectsForOperation"
            ...
            , Response.view "EffectsForOperation" model.response model.isLoading
            ]
        ]