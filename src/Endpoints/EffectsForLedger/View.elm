...
view endpoint model =
    ...
    div
        []
        [ Title.view "Effects for Ledger" "https://www.stellar.org/developers/horizon/reference/endpoints/effects-for-ledger.html"
        , div
            [ Css.page ]
            [ RequestTitle.view "EffectsForLedger"
            ...
            , Response.view "EffectsForLedger" model.response model.isLoading
            ]
        ]