...
view endpoint model =
    ...
    div
        []
        [ Title.view "Operations for Ledger" "https://www.stellar.org/developers/horizon/reference/endpoints/operations-for-ledger.html"
        , div
            [ Css.page ]
            [ RequestTitle.view "OperationsForLEdger"
            ...
            , Response.view "OperationsForLEdger" model.response model.isLoading
            ]
        ]