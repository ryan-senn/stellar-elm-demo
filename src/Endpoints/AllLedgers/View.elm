...
view endpoint model =
    ...
    div
        []
        [ Title.view "All Assets" "https://www.stellar.org/developers/horizon/reference/endpoints/ledgers-all.html"
        , div
            [ Css.page ]
            [ RequestTitle.view "AllLedgers"
            ...
            , Response.view "AllLedgers" model.response model.isLoading
            ]
        ]