...
view endpoint model =
    ...
    div
        []
        [ Title.view "Operations for Account" "https://www.stellar.org/developers/horizon/reference/endpoints/operations-for-account.html"
        , div
            [ Css.page ]
            [ RequestTitle.view "OperationsForAccount"
            ...
            , Response.view "OperationsForAccount" model.response model.isLoading
            ]
        ]